...
public class ProfessionalTingFragment extends BaseRefreshFragment {
    ...
    public static ProfessionalTingFragment newInstance() {
        Bundle args = new Bundle();
        ProfessionalTingFragment fragment = new ProfessionalTingFragment();
    ...
    protected int getLayout() {
        return R.layout.fragment_professinal_ting;
    }
    ...
    protected void loadData2() {
        CoinTingRepository.getInstance().listCoinTing("PROFESSION", 0, COIN_TING_PAGE_SIZE)
    ...
    private void initHeaderView() {
        ...
        ((ImageView) headerView.findViewById(R.id.iv_cover)).setImageResource(R.drawable.bi_ting_zhuanye_banner);
        ((TextView) headerView.findViewById(R.id.tv_description)).setText(R.string.coin_ting_professional_ting_description);
        ...
        mAdapter.setOnLoadMoreListener(() -> CoinTingRepository.getInstance().listCoinTing("PROFESSION", mAdapter.getData().size(), COIN_TING_PAGE_SIZE)
                .compose(bindUntilEvent(RxLifeEvent.DESTROY))
                .subscribe(new DefaultSubscriber<CoinTingListProtocol>() {
                    @Override
                    public void _onNext(CoinTingListProtocol entity) {
